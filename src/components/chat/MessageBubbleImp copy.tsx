        ...
        {isEditing ? (
          <div className="space-y-2">
            {message.replyTo && (
              ...
              <div
                className={`text-sm rounded-lg ${message.replyTo.senderId === message.senderId
                    ? 'bg-pink-500 text-white'
                    : 'p-2 bg-gray-200 text-gray-900'
                  }`}>
                <div
                  className={`font-semibold text-xs ${message.replyTo.senderId === message.senderId ? 'text-white' : 'text-gray-700'
                    }`}>
                  {message.replyTo.senderId === message.senderId ? 'You' : message.replyTo.senderId}
                </div>
